//! useGraphPanel hook — state management, data loading, filtering, and navigation
//! shared by the desktop and mobile GraphPanel variants.
//! Extracted from GraphPanel.shared.tsx during the E6 sizing-gate refactor.
