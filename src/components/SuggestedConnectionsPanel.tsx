  ...
  return (
    <div className="border-t border-[var(--secondary-200)] dark:border-[var(--secondary-700)]">
      <div className="px-4 py-2 flex items-center justify-between">
        <h3 className="text-xs font-semibold text-[var(--secondary-600)] dark:text-[var(--secondary-400)] uppercase tracking-wider">
      ...
      {suggestions && suggestions.length === 0 && (
        <p className="px-4 pb-2 text-xs text-[var(--secondary-400)]">No connections found.</p>
      )}
      ...
      {suggestions === null && !busy && (
        <p className="px-4 pb-2 text-[10px] text-[var(--secondary-400)]">
